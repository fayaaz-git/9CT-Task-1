...
Year 9 students spend more time on their screens daily then reading a book weekly.
...
* The data would be visualised as either a Pandas dataframe or a Matplotlib bar graph (with the x-axis being the amount of time spent on their screens daily, y-axis being how long they spend reading a book weekly) depending on the user's preference.
